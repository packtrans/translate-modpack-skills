...
SNBT, otherwise know as Stringified NBT, is a way to write NBT (Named Binary Tag) data in a string. FTB's implementation of SNBT is pretty much compatible with vanilla SNBT, although FTB SNBT supports multiline structures, and does not require commas to delimit objects in such multiline structures.
